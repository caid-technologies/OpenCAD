...
Read [the packaged skill instructions](../../../skills/create-cad-files/SKILL.md) completely and follow them. Resolve all referenced scripts and references from `skills/create-cad-files/`; this repository adapter and the installable plugin intentionally share one implementation.
