...
class ToolRuntime:
    def __init__(
        ...
        *,
        ...
        self._use_live_kernel = live_kernel if live_kernel is not None else kernel_client is not None
    ...
    def get_shape_info(self, shape_id: str) -> dict[str, Any]:
        ...
        if self._use_live_kernel and self._kernel_client is not None:
            try:
                mesh = self._kernel_client.get_mesh(shape_id, 0.5)
